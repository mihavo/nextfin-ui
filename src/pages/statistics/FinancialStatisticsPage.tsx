...
export default function FinancialStatisticsPage() {
  ...
  const handleTabChange = (tab: string) => {
    setCurrentTab(tab as 'balance' | 'income' | 'expenses' | 'savings');
      ...
      <main className="flex flex-1 flex-col p-4 md:p-6">
        <div className="mb-6 flex items-center justify-between">
          <div>
            ...
            <h1 className="text-3xl font-bold">Financial Statistics</h1>
            <p className="text-muted-foreground">
              Comprehensive overview of your financial data and trends
            </p>
          </div>
        </div>
        ...
        >
          ...
          <TabsContent value="balance">{renderBalanceTab()}</TabsContent>
